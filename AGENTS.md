...
- Land Viewer **Closest** chips query public Overpass/Nominatim from the browser. They are hard-capped (~12s) so “Working” must never spin forever — empty/timeout shows a retry status instead.
